...
function ProfileLinks({ steamLink }) {
    return (
        <div className="flex flex-col gap-3 p-2.5">
            <a className="flex items-end gap-2 text-xl" href={steamLink.url} target="_blank"><FaSteam className="text-4xl text-raspberry" /> {steamLink.name}</a>
